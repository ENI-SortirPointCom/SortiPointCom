...
class SortieFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $user = new Sortie();
        $entities = [
            $this->make(self::REF_SORTIE, DateTime::createFromFormat($format, '2020-02-18 14:33:44'), DateTime::createFromFormat($format, '2020-02-18 17:33:43'), DateTime::createFromFormat($format, '2020-02-20 17:33:43'), UserFixtures::REF_TRISTAN, 10, 'pas d\'infos', LieuFixtures::REF_PARC, EtatFixtures::REF_OUVERT),
            $this->make(self::REF_SORTIE2, DateTime::createFromFormat($format, '2020-02-22 14:33:43'), DateTime::createFromFormat($format, '2020-02-22 17:33:43'), DateTime::createFromFormat($format, '2020-03-25 17:33:43'), UserFixtures::REF_ARNAUD, 10, 'pas d\'infos', LieuFixtures::REF_MER, EtatFixtures::REF_OUVERT)
